...
<div class="sidebar">
    ...
    <a href="courses.php" class="active"><i class="fa-solid fa-book me-2"></i>Course Registration</a>
...
<div class="main">
    <div class="navbar">
        <h3><i class="fa-solid fa-book-open me-2" style="color: #2563eb;"></i>Next Semester Course Registration</h3>
        <div>
            <span style="font-weight: 600; color: #166534; background: #dcfce7; padding: 6px 14px; border-radius: 20px; font-size: 13px;">Total Enrolled: <span id="studentTotalCreditsHeader">0.0 Credits</span></span>
        </div>
    </div>

    <!-- Offered Courses Card -->
    <div class="card">
        <h3 style="font-size: 18px; color: #1e3a8a; margin-bottom: 10px;"><i class="fa-solid fa-list-check me-2" style="color: #2563eb;"></i>Courses Offered by Admin for Next Semester</h3>
        <p style="font-size: 13px; color: #64748b; margin-bottom: 15px;">Tuition Fee Rate: <strong>3,000 BDT / Credit</strong>. Click "Register" to add courses to your schedule.</p>
        ...
        <table>
            ...
            <tbody id="availableCoursesTbody"></tbody>
        </table>
    </div>

    <!-- Registered Courses Card -->
    <div class="card">
        <h3 style="font-size: 18px; color: #166534; margin-bottom: 10px;"><i class="fa-solid fa-circle-check me-2"></i>My Registered Courses</h3>
        <table>
            <thead>
                <tr>
                    <th>Code</th>
